...
urlpatterns = [
    ...
    path('documents/<int:doc_id>/describe', document_views.document_describe, name='document-describe'),

    # Cases
    path('cases', case_views.case_list, name='case-list'),
    path('cases/<int:case_id>', case_views.case_detail, name='case-detail'),
    path('cases/<int:case_id>/documents', case_views.case_add_documents, name='case-add-documents'),
    path('cases/<int:case_id>/documents/<int:doc_id>', case_views.case_remove_document, name='case-remove-document'),
